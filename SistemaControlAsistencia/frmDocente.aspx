<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmDocente.aspx.cs" Inherits="SistemaControlAsistencia.frmDocente" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <h2>Mantenimiento de la tabla Docente</h2>
        ...
        <div class="form-group">
            <asp:GridView runat="server" ID="gvDocente" CssClass="table table-striped" AutoGenerateColumns="False" OnRowCommand="gvDocente_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Button ID="btnEditar" runat="server" Text="Editar" CommandName="Editar" CommandArgument='<%# Eval("IdDocente") %>' CssClass="btn btn-warning" />
                            <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CommandName="Eliminar" CommandArgument='<%# Eval("IdDocente") %>' CssClass="btn btn-danger" OnClientClick="return confirm('¿Está seguro de que desea eliminar este docente?');"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
